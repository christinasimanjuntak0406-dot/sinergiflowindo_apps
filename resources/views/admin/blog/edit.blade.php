...
<form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <div class="form-group">
        ...
        <textarea name="konten" id="konten"
                  ...
                  style="display:none;">{{ old('konten', $blog->konten) }}</textarea>
    ...
    <div class="col-md-4">
        ...
        <div class="mb-2">
          @if($blog->gambar)
            <img id="preview-gambar"
                 ...
                 alt="Gambar saat ini">
            <div id="placeholder-gambar" style="display:none;"></div>
          @else
      ...
      <div class="form-group">
        ...
        <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
          ...
          @foreach($categories as $cat)
            <option value="{{ $cat->id }}"
              {{ old('kategori_id', $blog->kategori_id) == $cat->id ? 'selected' : '' }}>
              {{ $cat->name }}
            </option>
          @endforeach
        </select>
      ...
      {{-- Info Views --}}
      <div class="form-group">
        <label>Jumlah Tayangan</label>
        <input type="text" class="form-control"
               value="{{ number_format($blog->views) }} kali dilihat" disabled>
      </div>
