        ...
        <div class="card-body p-4">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi"
                          ...
                          rows="4"
                          placeholder="Jelaskan layanan ini...">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <i id="iconPreview" class="fas {{ old('ikon', $layanan->ikon ?? 'fa-concierge-bell') }}"></i>
                        </span>
                    </div>
            ...
            <div class="form-group">
                ...
                <select name="status_aktif" class="form-control" style="max-width:200px;">
                    <option value="1" {{ old('status_aktif', $layanan->status_aktif) == '1' ? 'selected' : '' }}>
                        Aktif
                    </option>
                    <option value="0" {{ old('status_aktif', $layanan->status_aktif) == '0' ? 'selected' : '' }}>
                        Nonaktif
                    </option>
                </select>
            </div>
